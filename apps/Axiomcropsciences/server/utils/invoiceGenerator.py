"""
Axiom Seeds Invoice Generator — ReportLab
...
# ─────────────────────────────────────────
# Brand colors (from Axiom Seeds design system)
# ─────────────────────────────────────────
...
def generate_invoice(order: dict, output_path: str = None) -> bytes:
    ...
    logo_path = os.path.normpath(os.path.join(base_dir, "../../client/public/uploads/Axiom Seeds_logo.png"))
    if os.path.exists(logo_path):
        ...
        logo_flowable.add(String(36, 10, "AXIOM SEEDS", fontName="Helvetica-Bold", fontSize=14, fillColor=colors.HexColor("#1A3322")))
...
if __name__ == "__main__":
    ...
    generate_invoice(sample_order, output_path="Axiom Seeds_Invoice_SAMPLE.pdf")
    print("Invoice generated: Axiom Seeds_Invoice_SAMPLE.pdf")
